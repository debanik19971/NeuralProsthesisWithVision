...
if __name__ == '__main__':
    ...
    # l = iLimbController('COM9')
    # l.connect()
    # l.control(['thumb','index','middle'],['open']*3,[290]*3)

    # urpose = URPoseManager()
    # urpose.load('rightcap_start.urpose')
    # #moving to home
    # urpose.moveUR(U1,'homej',3)
    # time.sleep(3.2)

    # urpose.load('rightcap.urpose')
    # #moving to home
    # urpose.moveUR(U1,'homej',3)
    # time.sleep(3.2)
    ...
    # dist_pivot = 220
    # grasp_pivot = 65   
    # l.control(['thumb','index','middle'],['position']*3,[75,150,0])
    # U1.read_joints()
    # Sim.set_joints(U1.joints)
    # U1.xyzR = Sim.joints2pose()
    # old_xyzR = copy(U1.xyzR)
    # old_xyzR[2] = old_xyzR[2] + 10 
    # U1.movej(old_xyzR ,3  )
    ...
    #     #U1.movej(new_xyzR,2)
    #     if i >0:
    #         urpose.moveUR(U1,'homej',1)
    #         time.sleep(1.2)
    #     l.control(['thumb','index','middle'],['position']*3,[100,180,0])
    #     time.sleep(0.5)
    #     U1.read_joints()
    #     Sim.set_joints(U1.joints)
    #     U1.xyzR = Sim.joints2pose()
    ...
    #     # U1.do_circular_pivot_motion(angle, 190,"z",3,20)
    #     U1.movej(new_xyzR,1)
    ...
    # U1.xyzR = Sim.joints2pose()
    # old_xyzR = copy(U1.xyzR)
    # old_xyzR[0] = old_xyzR[0] + 20 
    # old_xyzR[2] = old_xyzR[2] - 15
    # U1.movej(old_xyzR ,3)
    # time.sleep(3.2)
    # l.control(['thumb','index','middle'],['position']*3,[30,180,0])
    # time.sleep(1)
    # U1.read_joints()
    # Sim.set_joints(U1.joints)
    # U1.xyzR = Sim.joints2pose()
    # old_xyzR = copy(U1.xyzR)
    # old_xyzR[2] = old_xyzR[2] + 100 
    # U1.movej(old_xyzR ,3)
    # time.sleep(3.2)
    # urpose.load('rightcap_start.urpose')
    # #moving to home
    ...
    # urpose.moveUR(U1,'homej',3)
    # time.sleep(3.2)
    # l.control(['thumb','index','middle'],['position']*3,[150,150,0])
    #close the fingers
    # #Bimanual
    #     l.control(['thumb','index','middle'],['open']*3,[290]*3)
#     time.sleep(1)
